    ...
    <div className="min-h-screen bg-gradient-warm">
      ...
      <main className="container mx-auto px-6 py-12">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-5xl font-bold text-gray-900 mb-6 leading-tight">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-primary"> Data-Driven Insights</span>
          </h2>
          ...
          <button
            ...
            className="inline-flex items-center px-8 py-4 bg-white border border-gray-300 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200 text-gray-700 font-semibold text-lg"
          >
        ...
        <div className="grid md:grid-cols-3 gap-8 mt-20">
          ...
          <div className="bg-white rounded-2xl p-8 shadow-lg card-hover">
            <div className="w-12 h-12 bg-warm-100 rounded-xl flex items-center justify-center mb-6">
              <Target className="w-6 h-6 text-warm-600" />
            </div>
        ...
        <div className="text-center mt-20">
          <div className="bg-white rounded-2xl p-12 shadow-lg max-w-2xl mx-auto">
            ...
            <button
              onClick={handleGoogleLogin}
              className="btn-hover px-8 py-4 bg-gradient-primary text-white rounded-xl font-semibold text-lg shadow-lg"
            >
      ...
      <footer className="container mx-auto px-6 py-8 mt-20 border-t border-gray-200">
        <div className="text-center text-gray-500">
          <p>&copy; 2024 TikTok Creator Compass. Built with ❤️ for creators.</p>
        </div>
      </footer>
    </div>
  );
